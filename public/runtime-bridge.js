...
(function(){
  ...
  function openAIAfterAuth(){
    ...
    const go=()=>{if(typeof window.newChat==='function'){sessionStorage.removeItem('venom-open-ai');setTimeout(()=>window.newChat(),90);return true}return false};
    if(!go()){let n=0;const t=setInterval(()=>{if(go()||++n>40)clearInterval(t)},100)}
  }
