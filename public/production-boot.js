...
(()=>{
  ...
  const boot=async()=>{
    ...
    console.info('[VENOM] production '+VERSION+' loaded: authoritative UI + Spider-Tech cinematic map + welcome + OAuth + sharp eyes + pricing/contact/nav + expanded app ecosystem');
  };
