/* VENOM GPT WORLD TRACKER V5 — polished, restrained world map layer */
(()=>{
  ...
  function style(){
    ...
    const s=document.createElement('style'); s.id=STYLE; s.textContent=`
      ...
      #tracker .vgWorldLabels{opacity:.34!important}
      #tracker .vgGraticule{opacity:.06!important}
      #tracker .vgSightPath{display:none!important}
      #tracker .vgOceanLine{opacity:.10!important}
